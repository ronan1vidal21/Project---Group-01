...
# Ensure project root (parent of 'backend') is on sys.path so 'backend' is importable
project_root = Path(__file__).resolve().parents[1]  # ../.. -> project root that contains 'backend'
